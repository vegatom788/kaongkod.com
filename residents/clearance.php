			...
			<div class="container-fluid">
				<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="ti-agenda"></i>Brgy. Clearance</li>
					</ul>
				</div> 
											...
											<div class="col-lg-12">
												<div id="request_button">
													...
													<form onsubmit="return confirmSubmit()" method="post" action="">
														<input type="hidden" name="message" value="Some purpose"> <!-- Add other form fields as necessary -->
														<input type="hidden" name="payment_method" value="<?php echo isset($row['purpose']) ? htmlspecialchars($row['purpose']) : ''; ?>">
