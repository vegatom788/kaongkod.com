		...
		<main class="ttr-wrapper" style="background-color: #FCFCFC;">
			<div class="container-fluid">
				<div class="db-breadcrumb">
					<h4 class="breadcrumb-title">Manage Documents</h4>
					<ul class="db-breadcrumb-list">
						<li><i class="ti-book"></i>Documents</li>
					</ul>
				</div>  
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
								...
								?>
								<div align="right">
									<a href="" class="btn green radius-xl" style="background-color: <?php echo $primary_color; ?>;" data-toggle="modal" data-target="#add-announcement"><i class="ti-book"></i><span>&nbsp;ADD NEW ISSUANCE</span></a>&nbsp;&nbsp;<a href="archived-issuance" class="btn red radius-xl"><i class="ti-archive"></i><span>&nbsp;ARCHIVED ISSUANCE</span></a>
								</div>
								...
								<div class="table-responsive">
									<table id="table" class="table hover" style="width:100%">
										...
										<tbody>
											...
											?>
											<tr>
												<td style="background-color: #333333;"><a href="../assets/images/announcement/<?php echo $row['image_unique']; ?>.png" target="_blank"><img src="../assets/images/announcement/<?php echo $row['image_unique']; ?>.png" style="width: 100%;"></a></td>
												...
												<td>
													<center>
														...
														<button data-toggle="modal" data-target="#archive-<?php echo $row['id']; ?>" class="btn red" style="width: 50px; height: 37px; margin: 2px;">
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Edit Issuance</h4>
															...
															<div class="modal-body">
																...
																<div class="row">
																	...
																	<div class="form-group col-12" style="background-color: green;">
																		<center>
																			<img id="display-img-<?php echo $row['id']; ?>" src="../assets/images/announcement/<?php echo $row['image_unique']; ?>.png" style="width: 60%;">
																		</center>
																	</div>
																	<div class="form-group col-12">
											...
											<div id="archive-<?php echo $row['id']; ?>" class="modal fade" role="dialog">
												<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Archive Issuance</h4>
																<button type="button" class="close" data-dismiss="modal">&times;</button>
															</div>
															<div class="modal-body">
																...
																<div class="row">
																	...
																	<div class="form-group col-12" style="background-color: green;">
																		<center>
																			<img id="display-img-<?php echo $row['id']; ?>" src="../assets/images/announcement/<?php echo $row['image_unique']; ?>.png" style="width: 500px; height: 300px; object-fit: cover;">
																		</center>
																	</div>
																	<div class="form-group col-12">
															...
															<div class="modal-footer">
																<input type="submit" class="btn red radius-xl outline" name="archive" value="Archive Issuance">
																<button type="button" class="btn red outline radius-xl" data-dismiss="modal">Close</button>
															</div>
														</div>
													</div>
								...
								<div id="add-announcement" class="modal fade" role="dialog">
									<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												<div class="modal-header">
													<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Add Issuance</h4>
													<button type="button" class="close" data-dismiss="modal">&times;</button>
												</div>
												<div class="modal-body">
													<div class="row">
												...
												<div class="modal-footer">
													<input type="submit" class="btn green radius-xl outline" name="add_announcement" value="Add Issuance">
													<button type="button" class="btn red outline radius-xl" data-dismiss="modal">Close</button>
												</div>
											</div>
										</div>
