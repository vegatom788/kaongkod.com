								...
								<div class="row align-items d-flex">
									<div class="col-lg-12 col-md-12">
										<div class="heading-bx left">
											...
											<p style="text-align: justify; "><?php echo $guidelines; ?></p>
											<a href="edit-guidelines?id=4" class="btn blue radius-xl" style="float: left;background-color: <?php echo $primary_color; ?>"><i class="ti-marker-alt"></i><span>&nbsp;&nbsp;EDIT DETAILS</span></a>	
									</div>
								</div>
								<br><hr><br>
