				...
				<nav class="ttr-sidebar-navi">
					<ul>
						...
						<li class="show">
							...
							<ul>
								<li>
									<a href="content-management" class="ttr-material-button"><span class="ttr-label" style="color: <?php echo $primary_color; ?>">Story, Logo, Vission, Mission</span></a>
								</li>
								<li>
					...
					<div class="col-lg-12 m-b30">
								...
								<div class="row align-items d-flex">
									<div class="col-lg-4 col-md-12">
										<form method="POST">
											...
											<?php if ($content_id == 1) { ?>
												<textarea class="form-control" name="content" required id="edit"><?php echo $clearance; ?></textarea><br>
												<button type="submit" name="clearance" class="btn blue radius-xl" style="float: left;background-color: <?php echo $primary_color; ?>"><i class="ti-marker-alt"></i><span>&nbsp;&nbsp;SAVE CHANGES</span></button>
											<?php }
												else { ?>
												<p style="text-align: justify; "><?php echo $clearance; ?></p><br>
									...
									<div class="col-lg-4 col-md-12">
										<form method="POST">
											...
											<?php if ($content_id == 2) { ?>
												<textarea class="form-control" name="content" required id="edit"><?php echo $residency; ?></textarea><br>
												<button type="submit" name="residency" class="btn blue radius-xl" style="float: left;background-color: <?php echo $primary_color; ?>"><i class="ti-marker-alt"></i><span>&nbsp;&nbsp;SAVE CHANGES</span></button>
											<?php }
												else { ?>
												<p style="text-align: justify; "><?php echo $residency; ?></p><br>
									...
									<div class="col-lg-4 col-md-12">
										<form method="POST">
											...
											<?php if ($content_id == 3) { ?>
												<textarea class="form-control" name="content" required id="edit"><?php echo $indigency; ?></textarea><br>
												<button type="submit" name="indigency" class="btn blue radius-xl" style="float: left;background-color: <?php echo $primary_color; ?>"><i class="ti-marker-alt"></i><span>&nbsp;&nbsp;SAVE CHANGES</span></button>
											<?php }
												else { ?>
												<p style="text-align: justify; "><?php echo $indigency; ?></p><br>
								...
								<?php
									...
									if (isset($_POST['clearance'])) {
										$model->editContent('clearance', $_POST['content']);
										echo "<script>window.open('instructions', '_self');</script>";
									}

									if (isset($_POST['residency'])) {
										$model->editContent('residency', $_POST['content']);
										echo "<script>window.open('instructions', '_self');</script>";
									}

									if (isset($_POST['indigency'])) {
										$model->editContent('indigency', $_POST['content']);
										echo "<script>window.open('instructions', '_self');</script>";
									}
