		...
		<main class="ttr-wrapper" style="background-color: #FCFCFC;">
			<div class="container-fluid">
				<div class="db-breadcrumb">
					<h4 class="breadcrumb-title">Manage Issuance</h4>
					<ul class="db-breadcrumb-list">
						<li><i class="ti-book"></i>Issuance</li>
					</ul>
				</div> 
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
								...
								?>
								<div align="right">
									<a href="issuance" class="btn green radius-xl" style="float: right;background-color: #267621;"><i class="ti-book"></i><span>&nbsp;ISSUANCE</span></a><br>
								</div>
								...
								<div class="table-responsive">
									<table id="table" class="table hover" style="width:100%">
										...
										<tbody>
											...
											?>
											<tr>
												<td style="background-color: green;"><a href="../assets/images/announcement/<?php echo $row['image_unique']; ?>.png" target="_blank"><img src="../assets/images/announcement/<?php echo $row['image_unique']; ?>.png" style="width: 120px;height: 60px; object-fit: cover;"></a></td>
												...
												<td>
													<center>
														...
														<button data-toggle="modal" data-target="#delete-<?php echo $row['id']; ?>" class="btn red" style="width: 50px; height: 37px; margin: 2px;">
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Delete Archived Issuance</h4>
																<button type="button" class="close" data-dismiss="modal">&times;</button>
															</div>
															<div class="modal-body">
																<input type="hidden" name="delete-id" value="<?php echo $row['id']; ?>">
																<p>Are you sure you want to delete this archived issuance?</p>
															</div>
											...
											<?php
												try {
													...
													if (isset($_POST['delete'])) {
														...
														if ($model->deleteArchivedIssuance($id)) {
															echo "<script>alert('Issuance deleted successfully');</script>";
														} else {
															echo "<script>alert('Issuance deleted successfully');</script>";
														}

														// Redirect back to the same page after deletion
														echo "<script>window.open('archived-issuance.php', '_self');</script>";
														exit;
													}
											...
											<div id="archive-<?php echo $row['id']; ?>" class="modal fade" role="dialog">
												<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Restore Issuance</h4>
																<button type="button" class="close" data-dismiss="modal">&times;</button>
															</div>
															<div class="modal-body">
											...
											<?php 
												...
												if (isset($_POST['archive'])) {
													...
													echo "<script>
																	Swal.fire({
																		title: 'Restored!',
																		text: 'Issuance has been restored successfully.',
																		icon: 'success',
																		...
																		if (result.isConfirmed) {
																			window.location.href = 'archived-issuance';
																		}
																	});
																</script>";
												}
