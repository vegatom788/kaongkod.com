													...
													<div class="modal-body">
														<div class="row">
															...
															<div class="form-group col-12">
																...
																<input class="form-control" type="text" value="<?php echo $row['payment_method']; ?>" readonly>
															</div>
															<div class="form-group col-12">
																<label class="col-form-label">Reference Number</label>
																<input class="form-control" type="text" value="<?php echo $row['reference_number']; ?>" readonly>
															</div>
															<div class="form-group col-12">
																<label class="col-form-label">Pickup Date</label>
																<input class="form-control" type="date" name="pickup-date" min="<?php echo date('Y-m-d', strtotime("+0 day", strtotime($row['date_issued']))); ?>" required>
															</div>
														</div>
													</div>
