			...
			<div class="container-fluid">
				<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="ti-agenda"></i>Blotters Statistics</li>
					</ul>
				</div>  
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
						<div align="right">
							<a href="blotters" class="btn green radius-xl"><i class="ti-agenda"></i><span>&nbsp;VIEW BLOTTER RECORDS</span></a>
						</div>
						<div style="padding: 25px;"></div>
						<center>
							<h2 style="color: #222831;">BLOTTER STATISTICS</h2>
						</center>
