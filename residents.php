				...
				<div class="account-container">
					...
					<form class="contact-bx" method="POST">
						...
						<div class="form-group form-forget">
							<div class="g-recaptcha" data-sitekey="6LdCD2cqAAAAAHSmYSbeVAzzNbA_7khE_ALMqqY5" style="transform: scale(0.55); transform-origin: 0 0; height: 28px; width: 10px;"></div>
