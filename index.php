...
<style type="text/css">
    #loading-icon-bx {
        ...
        background-size: 200px!important; /* Adjust size or other properties as needed */
    }
</style>
		...
		<div class="sticky-header navbar-expand-lg">
            <div class="menu-bar clearfix">
                <div class="container clearfix">
					<div class="menu-logo">
						<a href="index"><img src="assets/images/3r.png" alt=""></a>
					</div>
				...
				<div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
					<ul>	<!-- SLIDE  -->
						...
						data-description="Science says that Women are generally happier">
							<!-- MAIN IMAGE -->
							<img src="assets/images/slider/1t.jpg" alt="" 
							...
							<div class="tp-caption tp-shape tp-shapewrapper " 
								...
								style="z-index: 5;background-color:rgba(255, 192, 203, 0.40);border-color:rgba(0, 0, 0, 0);border-width:0px;"> </div>	
							<!-- LAYER NR. 2 -->
							<div class="mainText tp-caption Newspaper-Title   tp-resizeme" 
								...
								style="z-index: 6; font-family:rubik; font-weight:700; text-align:center; white-space: normal;">
									BARANGAY <span style="color: rgb(255, 192, 203);">KAONGKOD</span>
							</div>
							...
							<a href="residents.php"><div class="tp-caption Newspaper-Button rev-btn " 
								...
								style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; background-color:var(--primary) !important; border:0; border-radius:30px; margin-right:5px;">LOGIN NOW </div></a>
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption tp-shape tp-shapewrapper " 
								...
								data-paddingbottom="[0,0,0,0]"
								data-paddingleft="[0,0,0,0]"
								style="z-index: 5;background-color:rgba(255, 192, 203, 0.40);border-color:rgba(0, 0, 0, 0);border-width:0px;"> 
							</div>
							...
							<div class="tp-caption Newspaper-Title   tp-resizeme" 
								...
								style="z-index: 6; font-family:rubik; font-weight:700; text-align:center; white-space: normal;text-transform:uppercase;">
									BRGY. <span style="color: rgb(255, 192, 203);">KAONGKOD</span> RECORD MANAGEMENT SYSTEM
							</div>
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								data-paddingbottom="[0,0,0,0]"
								data-paddingleft="[0,0,0,0]"
								style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:18px; line-height:50px; font-weight:400;">
		...
		<div class="content-block">
                ...
                <div class="container">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-12">
							<div class="service-bx">
								<div class="action-box">
									<img src="assets/images/our-services/n3.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
										<i class="fa fa-bank text-primary"></i>
									</div>
									<h4><a href="officials">Brgy. Officials</a></h4>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								<div class="action-box">
									<img src="assets/images/our-services/n4.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx m-b0">
								<div class="action-box">
									<img src="assets/images/our-services/n2.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
							...
							<div class="event-bx">
								...
								<div class="info-bx d-flex">
									...
									<div class="event-info">
										...
										<p><?php echo substr($row['details'], 0, 150); ?><a href="announcement-details?id=<?php echo $row['id']; ?>" style="color: #1043A9;">.... See More</a></p>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="section-area section-sp2">
				<div class="container">
					<div class="row">
						<div class="col-md-12 heading-bx left">
							<h2 class="title-head">Barangay <span>Officials</span></h2>
							<p>Officials of Barangay Kaongkod.</p>
						</div>
					</div>	
					 <div class="row">
                ...
                <div class="container">
					<div class="row">
						<div class="heading-bx left">
							...
							<p>Barangay Kaongkod can generate brgy. clearance, certificate of indigency.</p>
						</div>
					</div>	
					 <div class="pricingtable-row">
						<div class="row justify-content-center">
							...
							?>
							<div class="col-sm-12 col-md-6 col-lg-4 m-b40">
